...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        m_operator.square().whileTrue(BaseCommands.setHeight(elevator, outtake, Height.L2));

        m_operator.circle().whileTrue(BaseCommands.setHeight(elevator, outtake, Height.L3));

        m_operator.triangle().whileTrue(BaseCommands.setHeight(elevator, outtake, Height.L4));
