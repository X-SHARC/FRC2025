...
public final class Constants {
  ...
  public final class GeneratorConstants {
    ...
    public static final PathConstraints constraints = new PathConstraints(3, 3, Units.degreesToRadians(360),
        Units.degreesToRadians(720), 12);
  }
  ...
  public static final class FieldConstants {
    ...
    public static final List<Pose2d> SOURCEPOSE_LIST = List.of(
        new Pose2d(1.15, 1.10, Rotation2d.fromDegrees(53.5)),
        new Pose2d(1.15, 7, Rotation2d.fromDegrees(-53.5)));

    public static final List<Pose2d> SIDEPOSE_LIST = List.of(
